...
urlpatterns = [
    ...
    path('edit_chat/', views.edit_chat_view, name='edit_chat'),  # Страница редактирования чата по ID
    path('delete/', views.delete_chat_view, name='delete_chat'),  # Страница удаления чата
